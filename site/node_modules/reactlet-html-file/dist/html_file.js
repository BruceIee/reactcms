...
// HtmlInput component
var HtmlFile = React.createClass({displayName: "HtmlFile",
    name: 'html-file',
    ...
    getAttributes: function() {
        var attributes = [
            ...
            { name:'value', type:'string', required:false, defaultValue:'', note:'input value' }
        ];
        return attributes;
    },
    ...
    render: function() {
        // set content display
        var content = 
            React.createElement("div", {className:  "form-group html-file-content-container" }, 
