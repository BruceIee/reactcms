...
var HtmlInput = React.createClass({displayName: "HtmlInput",
    ...
    components: {
        ...
        HtmlFile: React.createFactory(HtmlFile),
    ...
    render: function() {
        ...
        console.log('>>> html form - action:', this.state.action, ' method:', this.state.method);
        
        var content = 
            React.createElement("div", {className: "html-form-content-container"}, 
                React.createElement("form", {action:  this.state.action, method:  this.state.method, enctype: "multipart/form-data"}, 
                     fields 
                )
            );
        return (
