...
module.exports = React.createClass({displayName: "exports",
    ...
    render: function() {
        ...
        if (this.state.type !== 'hidden') {
            label = React.createElement("label", null,  this.state.label);
        }
        if (this.state.type == 'file' && this.state.value) {
            currentValue = React.createElement("div", null, React.createElement("label", null,  this.state.value[0].originalname));
        }
        var content = 
