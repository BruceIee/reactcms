    ...
    render: function() {
        ...
        var tableObject = 
            <div className={ this.state.containerClassNames.join(' ') } >
                <div className="table2-content-container"
...
var TableHeadCell = React.createClass({
    ...
    render: function() {
        ...
        // set content display
        var content =
            <div className="table2-head-cell-content-container" >
                <span className="table2-head-cell-text-container">{ this.state.text }</span>
...
var TableBodyCell = React.createClass({
    ...
    render: function() {
        ...
        var content =
            <div className="table2-body-cell-content-container" >
                <span className="table2-body-cell-text-container">{ displayText }</span>
            </div>;
        return (
            <div className={ this.state.containerClassNames.join(' ') }
