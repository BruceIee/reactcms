...
Engine.prototype.getSqlField = function(field, fieldModel) {
    ...
    switch(fieldModel.type) {
        ...
        case 'object':
            ...
            break;
        default:
            console.log('WARN unknown type in toSqlField. type=' + fieldModel.type);
    }
    var result = '';
    if (sqlType) {
...
Engine.prototype.toSqlValue = function(field, doc, model) {
    ...
    switch(fieldModel.type) {
        ...
        case '_id':
            ...
            break;
        default:
            console.log('WARN unknown type in toSqlValue. type=' + fieldModel.type);
    }
    return result;
};
...
Engine.prototype.fromSqlValue = function(value, fieldModel) {
    ...
    try {
        ...
        case 'object':
            ...
            break;
        default:
            console.log('fromSqlValue: ' + value + ', type unknown: ' + fieldModel.type);
            result = value;
        }
    } catch (e) {
        console.log('error in fromSqlValue: ' + e);
        ...
        for (var p in condition) {
            if (/^\$/.test(p)) {
                if (p == '$or') {
                    ...
                    console.log('Unknown query condition ' + p);
                }
            } else {
    ...
    if (filter) {
        ...
        if (filter.sort) {
            ...
            if (filter.sort.constructor === String) {
                ...
                console.log('Unknown sort data:' + filter.sort);
