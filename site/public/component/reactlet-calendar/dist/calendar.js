...
var CalendarMonth = React.createClass({displayName: "CalendarMonth",
    ...
    render: function() {
        ...
        dayHeaders.map(function(dayHeader) {
            calendarItems.push(React.createElement(CalendarHeader, {name:  dayHeader.name, key:  dayHeader.name}));
        });
        ...
        return (
            React.createElement("div", {className: "calendar-container"}, 
                React.createElement("div", {className: "calendar-caption"}, 
                     calendarCaption 
                ), 
    ...
    */
    ...
    render: function() {
        ...
        this.props.events.map(function(event) {
            items.push(React.createElement("div", {className:  'calendar-item ' + event.category},  event.title));
        });
        return (
            React.createElement("div", {className:  this.state.dayClassNames.join(' '), 
                onClick:  this.onClick, 
                onMouseEnter:  this.onMouseEnter, 
                onMouseLeave:  this.onMouseLeave
                }, 
                React.createElement("div", {className:  this.state.dayHeaderClassNames.join(' ') },  this.props.name), 
                React.createElement("div", {className:  this.state.dayBodyClassNames.join(' ') },  items )
            )
        );
    }
});
