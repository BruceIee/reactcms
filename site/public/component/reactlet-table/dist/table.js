...
var Table = React.createClass({displayName: "Table",
    ...
    onTableDoubleClick: function(event) {
        var target = $(event.target);
        if (target.hasClass('table-body-cell-container') ||
            target.hasClass('table-body-cell-content-container') ||
            target.hasClass('table-body-cell-text-container') ) {
            this.onRowDoubleClick(event);
        }
        this.fire('table-cell-double-click', [{ target:target }]);
    },
    ...
    onRowDoubleClick: function(event) {
        ...
        if (itemId) {
            this.state.activeItemId = itemId;
            this.fire('table-row-double-click', [{ id:itemId }]);
        }
    },
    ...
    render: function() {
        ...
        var tableObject = 
            React.createElement("div", {className:  this.state.containerClassNames.join(' ') }, 
                React.createElement("div", {className: "table-content-container", 
...
var TableHeadCell = React.createClass({displayName: "TableHeadCell",
    ...
    render: function() {
        ...
        // set content display
        var content =
            React.createElement("div", {className: "table-head-cell-content-container"}, 
                React.createElement("span", {className: "table-head-cell-text-container"},  this.state.text), 
...
var TableBodyCell = React.createClass({displayName: "TableBodyCell",
    ...
    render: function() {
        ...
        var content =
            React.createElement("div", {className: "table-body-cell-content-container"}, 
                React.createElement("span", {className: "table-body-cell-text-container"},  displayText )
            );
        return (
            React.createElement("div", {className:  this.state.containerClassNames.join(' '), 
